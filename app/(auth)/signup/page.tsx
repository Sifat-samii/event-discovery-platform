  ...
  return (
    <div className="relative flex min-h-screen flex-col">
      ...
      <div className="fixed inset-0 bg-background">
        <div
          aria-hidden
          className="pointer-events-none absolute -right-24 -top-24 h-96 w-96 rounded-full bg-primary/14 blur-[100px]"
        />
        <div
          aria-hidden
          className="pointer-events-none absolute bottom-16 left-16 h-64 w-64 rounded-full bg-amber-400/8 blur-[80px]"
        />
      </div>
