...
export default function SignupPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center p-5 overflow-hidden">
      <div className="orb orb-blue h-80 w-80 -top-32 -left-32 opacity-25" />
      <div className="orb orb-primary h-64 w-64 -bottom-24 -right-24 opacity-20" style={{ animationDelay: "4s" }} />
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="mt-1.5 text-sm text-muted-foreground">
            Sign up to discover and save events
          </p>
        </div>
        ...
        <div className="glass-surface shine-border p-6 space-y-5">
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            <div>
              <label htmlFor="fullName" className="block text-[13px] font-medium text-text-secondary mb-1.5">
                Full Name
              </label>
              <Input
                id="fullName"
